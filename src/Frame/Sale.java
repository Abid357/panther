...
public class Sale extends JFrame {
	...
	private JCheckBox isSaleDetailsCB;
	private RectangularButton saleDetailsB;

	public void setBackground(JLabel background) {
		BufferedImage img = null;
		try {
			img = ImageIO.read(new File(_GUIGlobals.directory + "\\Raw Materials\\Templates\\sale\\Slide1.jpg"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public JCheckBox getIsSaleDetailsCB() {
		return isSaleDetailsCB;
	}

	public RectangularButton getSaleDetailsB() {
		return saleDetailsB;
	}

	public Sale getFrame() {
		return this;
	}
	...
	private void initComponents() {
		...
		isSaleDetailsCB = new JCheckBox();
		saleDetailsB = new RectangularButton();
		inventoryNo = -1;
		invoiceNo = -1;
		transportTransactionNo = -1;
		...
		timeS.setFont(new Font("Century Gothic", 0, 13)); // NOI18N
		...
		amountTF.setFont(new Font("Century Gothic", 0, 18)); // NOI18N
		...
		chequeNoCB.setFont(new Font("Century Gothic", 0, 18)); // NOI18N
		...
		chequeNoCB.setMinimumSize(new Dimension(62, 20));
		...
		entityCB.setFont(new Font("Century Gothic", 0, 18)); // NOI18N
		entityCB.setForeground(_GUIGlobals.fontColor);
		entityCB.setBorder(null);
		entityCB.setMinimumSize(new Dimension(62, 20));
		...
		bankAccountCB.setFont(new Font("Century Gothic", 0, 18)); // NOI18N
		...
		itemTF.setFont(new Font("Century Gothic", 0, 24)); // NOI18N
		...
		selectItemB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
				if (isSaleDetailsCB.isSelected())
					Functions.create("ADD ITEM DETAILS");
				else
					new Notification("Please enter sale details first.");
			}
		...
		isSaleDetailsCB
				.setPreferredSize(new Dimension(getIsSaleDetailsCBSize().width, getIsSaleDetailsCBSize().height));
		isSaleDetailsCB.setForeground(_GUIGlobals.fontColor);
		isSaleDetailsCB.setBorder(null);
		isSaleDetailsCB.setEnabled(false);
		isSaleDetailsCB.setSelected(false);
		getContentPane().add(isSaleDetailsCB,
				new AbsoluteConstraints(getIsSaleDetailsCBPos().width, getIsSaleDetailsCBPos().height, -1, -1));

		saleDetailsB.setPreferredSize(new Dimension(251, 45));
		saleDetailsB.setBorder(null);
		saleDetailsB.addActionListener(new ActionListener() {

			@Override
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
				Functions.setTempObj(getFrame());
				Functions.create("ADD SALE DETAILS");
			}
		});
		getContentPane().add(saleDetailsB, new AbsoluteConstraints(341, 571, -1, -1));
