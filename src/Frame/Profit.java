...
public class Profit extends JFrame {
	...
	public void setBackground(JLabel background) {
		...
		try {
			img = ImageIO.read(new File(_GUIGlobals.directory + "\\Raw Materials\\Templates\\profit.jpg"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public Profit getFrame() {
		return this;
	}

	public Dimension getProfitDetailsBSize() {
		double wfactor = 7.64940239;
		double hfactor = 24;
		return (new Dimension((int) (_GUIGlobals.screenWidth / wfactor), (int) (_GUIGlobals.screenHeight / hfactor)));
	}

	public Dimension getProfitDetailsBPos() {
		double wfactor = 5.630498534;
		double hfactor = 1.891418564;
		return (new Dimension((int) (_GUIGlobals.screenWidth / wfactor), (int) (_GUIGlobals.screenHeight / hfactor)));
	}

	public Dimension getIsProfitDetailsCBSize() {
		double wfactor = 48;
		double hfactor = 27;
		return (new Dimension((int) (_GUIGlobals.screenWidth / wfactor), (int) (_GUIGlobals.screenHeight / hfactor)));
	}

	public Dimension getIsProfitDetailsCBPos() {
