...
public class Maintenance extends JFrame {
	...
	public void setBackground(JLabel background) {
		...
		try {
			img = ImageIO.read(new File(_GUIGlobals.directory + "\\Raw Materials\\Templates\\maintenance.jpg"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public void setEditable(boolean isEnabled) {
		...
		getVehicleCB().setEnabled(isEnabled);
	 ...
	 */
	public Maintenance(JPanel panel) {
		functionP = panel;
		initComponents();
	}
	...
	private void initComponents() {
		...
		vehicleCB.setBackground(_GUIGlobals.fontColor);
		vehicleCB.setFont(new Font("Century Gothic", 0, _GUIGlobals.getFontSize_18())); // NOI18N
		vehicleCB.setForeground(_GUIGlobals.fontColor);
		vehicleCB.setBorder(null);
		vehicleCB.setPreferredSize(
				new Dimension(Transaction.getEntityCBSize().width, Transaction.getEntityCBSize().height));
		vehicleCB.addItemListener(new ItemListener() {
		...
		getContentPane().add(vehicleCB, new AbsoluteConstraints(Transaction.getEntityCBPos().width,
