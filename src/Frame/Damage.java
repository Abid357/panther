...
public class Damage extends JFrame {
	...
	public void setBackground(JLabel background) {
		...
		try {
			img = ImageIO.read(new File(_GUIGlobals.directory + "\\Raw Materials\\Templates\\damage.jpg"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public Dimension getDamageTypeCBSize() {
		double wfactor = 10.49392713;
		double hfactor = 36;
		return (new Dimension((int) (_GUIGlobals.screenWidth / wfactor), (int) (_GUIGlobals.screenHeight / hfactor)));
	}

	public Dimension getDamageTypeCBPos() {
	...
	private void initComponents() {
		...
		getContentPane().add(itemTF,
				new AbsoluteConstraints(getItemTFPos().width, getItemTFPos().height, -1, -1));
		...
		getContentPane().add(selectItemB, new AbsoluteConstraints(getSelectItemBPos().width,
				getSelectItemBPos().height, -1, -1));
