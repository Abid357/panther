...
public class Purchase extends JFrame {
	...
	private JCheckBox isPurchaseDetailsCB;
	private RectangularButton purchaseetailsB;

	public void setBackground(JLabel background) {
		BufferedImage img = null;
		try {
			img = ImageIO.read(new File(_GUIGlobals.directory + "\\Raw Materials\\Templates\\localpurchase\\Slide1.jpg"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public JCheckBox getIsPurchaseDetailsCB() {
		return isPurchaseDetailsCB;
	}

	public RectangularButton getPurchaseDetailsB() {
		return purchaseetailsB;
	}

	public Purchase getFrame() {
		return this;
	}
	...
	private void initComponents() {
		...
		isPurchaseDetailsCB = new JCheckBox();
		purchaseetailsB = new RectangularButton();
		transportTransactionNo = -1;
		items = null;
		...
		selectItemB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
				if (isPurchaseDetailsCB.isSelected())
					Functions.create("ADD ITEM DETAILS");
				else
					new Notification("Please enter local purchase details first.");
			}
		...
		isPurchaseDetailsCB
				.setPreferredSize(new Dimension(getIsPurchaseDetailsCBSize().width, getIsPurchaseDetailsCBSize().height));
		isPurchaseDetailsCB.setForeground(_GUIGlobals.fontColor);
		isPurchaseDetailsCB.setBorder(null);
		isPurchaseDetailsCB.setEnabled(false);
		isPurchaseDetailsCB.setSelected(false);
		getContentPane().add(isPurchaseDetailsCB,
				new AbsoluteConstraints(getIsPurchaseDetailsCBPos().width, getIsPurchaseDetailsCBPos().height, -1, -1));
		
		purchaseetailsB.setPreferredSize(new Dimension(251, 45));
		purchaseetailsB.setBorder(null);
		purchaseetailsB.addActionListener(new ActionListener() {

			@Override
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
				Functions.setTempObj(getFrame());
				Functions.create("ADD LOCAL DETAILS");
			}
		});
		getContentPane().add(purchaseetailsB, new AbsoluteConstraints(341, 571, -1, -1));
