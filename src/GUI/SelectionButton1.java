...
public class SelectionButton1 extends javax.swing.JToggleButton {
	...
	public SelectionButton1(String name) {
		setBackground(new java.awt.Color(0, 0, 0));
		setFont(new java.awt.Font("Century Gothic", 0, _GUIGlobals.getFontSize_18()));
		...
		Main.getButtonGroup1().add(this);
		addActionListener(new ActionListener() {

			@Override
			public void actionPerformed(ActionEvent evt) {
				// TODO Auto-generated method stub
				if (((SelectionButton1) evt.getSource()).isSelected()) {
					LoadSelections.panel2(name);
					Main.getScrollPane2().repaint();
					Main.getScrollPane2().revalidate();
					Main.getScrollPane3().repaint();
					Main.getScrollPane3().revalidate();
				}
			}
		});
		Main.getPanel1().add(this);
	}
}
